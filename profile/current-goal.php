    ...
    <div class="goal-dashboard">
        ...
        <div class="goal-mobile-view">
            <div class="goal-mobile-header">
                <h1 class="goal-mobile-title"><?= t('my_fitness_goals') ?></h1>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateGoalCards(goals) {
                ...
                if (goals.length === 0) {
                    goalCardsContainer.innerHTML = `
                        <div class="goal-no-goals" style="display: block !important;">
                            ...
                            <h3 class="goal-empty-state-title">No goals match your current filters</h3>
                            <p class="goal-empty-state-text">Try changing your filters or add a new goal</p>
                            <button class="goal-btn goal-btn-primary goal-create-btn">
                ...
                const mobilePagination = goalCardsContainer.querySelector('.goal-mobile-pagination');
                if (mobilePagination) {
                ...
                goals.forEach(goal => {
                    const cardHtml = `
                        <div class="goal-card" 
                             data-id="${goal.id}" 
                             data-type="${goal.goal_type.toLowerCase()}" 
                             data-completed="${goal.completed ? 'true' : 'false'}"
                            ...
                            <div class="goal-header">
                                <h3>
                                    ${goal.title}
                                    <span class="goal-status-badge ${goal.status}">${goal.status.charAt(0).toUpperCase() + goal.status.slice(1)}</span>
                                </h3>
                                <div class="goal-actions">
                                    <button class="goal-action-btn goal-delete-btn" onclick="deleteGoal(${goal.id}); event.stopPropagation();">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                    <span class="goal-type">${goal.goal_type.charAt(0).toUpperCase() + goal.goal_type.slice(1)}</span>
                                </div>
                            </div>
                            ...
                            <div class="goal-footer">
                                <span class="deadline">Deadline: ${goal.formatted_deadline}</span>
                                <span class="days-left">${goal.days_left} days left</span>
                            </div>
                        </div>
                    `;
                    
                    goalCardsContainer.innerHTML += cardHtml;
                });
                
                if (mobilePagination) {
                    goalCardsContainer.appendChild(mobilePagination);
                }
            ...
            function updatePagination(pagination) {
                ...
                if (!mobilePaginationContainer && goalCardsContainer) {
                    ...
                    mobilePrevBtn.innerHTML = '<i class="fas fa-chevron-left"></i> Previous';
                    ...
                    mobileInfoSpan.innerHTML = 'Page <span id="mobile-pagination-current">1</span> of <span id="mobile-pagination-total">1</span>';
                    ...
                    mobileNextBtn.innerHTML = 'Next <i class="fas fa-chevron-right"></i>';
                ...
                if (!mobileViewPaginationContainer && mobileViewContainer) {
                    ...
                    mobileViewInfoSpan.innerHTML = 'Page <span id="mobile-view-pagination-current">1</span> of <span id="mobile-view-pagination-total">1</span>';
                ...
                if (paginationContainer) {
                    ...
                    if (paginationInfo) {
                        paginationInfo.innerHTML = `
                            Showing <span id="pagination-start">${pagination.start}</span> to 
                            <span id="pagination-end">${pagination.end}</span> of 
                            <span id="pagination-total">${pagination.total_goals}</span> goals
                        `;
                    }
                ...
                const mobilePaginationCurrent = document.getElementById('mobile-pagination-current');
                const mobilePaginationTotal = document.getElementById('mobile-pagination-total');
                ...
                if (mobilePrevButton) {
                    mobilePrevButton.dataset.page = Math.max(1, pagination.current_page - 1);
                    mobilePrevButton.classList.toggle('disabled', pagination.current_page <= 1);
                    
                    
                    const newMobilePrevButton = mobilePrevButton.cloneNode(true);
                    mobilePrevButton.parentNode.replaceChild(newMobilePrevButton, mobilePrevButton);
                    
                    newMobilePrevButton.addEventListener('click', function() {
                        if (!this.classList.contains('disabled')) {
                            const page = parseInt(this.dataset.page);
                ...
                if (mobileNextButton) {
                    mobileNextButton.dataset.page = Math.min(pagination.total_pages, pagination.current_page + 1);
                    mobileNextButton.classList.toggle('disabled', pagination.current_page >= pagination.total_pages);
                    
                    const newMobileNextButton = mobileNextButton.cloneNode(true);
                    mobileNextButton.parentNode.replaceChild(newMobileNextButton, mobileNextButton);
                    
                    newMobileNextButton.addEventListener('click', function() {
                        if (!this.classList.contains('disabled')) {
                            const page = parseInt(this.dataset.page);
                ...
                const mobileViewCurrentPage = document.getElementById('mobile-view-pagination-current');
                const mobileViewTotalPages = document.getElementById('mobile-view-pagination-total');
                ...
                if (mobileViewPrevButton) {
                    mobileViewPrevButton.dataset.page = Math.max(1, pagination.current_page - 1);
                    mobileViewPrevButton.classList.toggle('disabled', pagination.current_page <= 1);
                    
                    const newMobileViewPrevButton = mobileViewPrevButton.cloneNode(true);
                    mobileViewPrevButton.parentNode.replaceChild(newMobileViewPrevButton, mobileViewPrevButton);
                    
                    newMobileViewPrevButton.addEventListener('click', function() {
                        if (!this.classList.contains('disabled')) {
                            const page = parseInt(this.dataset.page);
                ...
                if (mobileViewNextButton) {
                    mobileViewNextButton.dataset.page = Math.min(pagination.total_pages, pagination.current_page + 1);
                    mobileViewNextButton.classList.toggle('disabled', pagination.current_page >= pagination.total_pages);
                    
                    const newMobileViewNextButton = mobileViewNextButton.cloneNode(true);
                    mobileViewNextButton.parentNode.replaceChild(newMobileViewNextButton, mobileViewNextButton);
                    
                    newMobileViewNextButton.addEventListener('click', function() {
                        if (!this.classList.contains('disabled')) {
                            const page = parseInt(this.dataset.page);
            ...
            function updateActiveFilters() {
                ...
                mobileTabs.forEach(tab => {
                    ...
                    if ((filter === 'active' && currentStatusFilter === 'on-track') ||
            ...
            function initFilters() {
                ...
                mobileTabs.forEach(tab => {
                    tab.addEventListener('click', function() {
                        ...
                        if (filter === 'active') statusFilter = 'on-track';
                ...
                document.querySelectorAll('.goal-pagination-button:not(.disabled)').forEach(button => {
                    button.addEventListener('click', function() {
                        const page = parseInt(this.dataset.page);
                        loadGoals(page, currentCategoryFilter, currentStatusFilter);
                    });
                ...
                if (mobileViewPrevButton) {
                    mobileViewPrevButton.addEventListener('click', function() {
                        if (!this.classList.contains('disabled')) {
                            const page = parseInt(this.dataset.page);
                            console.log('Mobile view prev clicked, loading page:', page);
                            loadGoals(page, currentCategoryFilter, currentStatusFilter);
                        }
                    });
                }
                ...
                if (mobileViewNextButton) {
                    mobileViewNextButton.addEventListener('click', function() {
                        if (!this.classList.contains('disabled')) {
                            const page = parseInt(this.dataset.page);
                            console.log('Mobile view next clicked, loading page:', page);
                            loadGoals(page, currentCategoryFilter, currentStatusFilter);
                        }
                    });
                }
            ...
            document.getElementById('goalForm')?.addEventListener('submit', function(e) {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        alert('Failed to add goal: ' + (data.message || 'Unknown error'));
                    }
                })
                .catch(error => {
