...
<body>
    ...
    <div class="membership-container">
        <div class="membership-header">
            <h1>MEMBERSHIP</h1>
            <p>GET PAID MEMBERSHIP<br>
            BUY NOW WHILST THEY ARE FRESH, DON'T MISS OUT ON YOUR OPPORTUNITY<br>
            FOR EXTRA BONUSES</p>
        </div>
        ...
        <div class="pricing-cards">
            <div class="pricing-card basic">
                ...
                <button class="join-button" onclick="window.location.href='/signup'">JOIN NOW</button>
            </div>
