...
<body>
    <header>
        ...
        <nav>
            ...
            <?php else: ?>
                <a href="login.php" style="margin-left: 20px; background-color: #333; color: white; padding: 8px 15px; border-radius: 5px;">
                    <i class="fas fa-sign-in-alt"></i> Login
                </a>
                <a href="register.php" style="margin-left: 10px; background-color: #ff4d4d; color: white; padding: 8px 15px; border-radius: 5px;">
